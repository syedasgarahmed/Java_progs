...
class Account {
    ...
    public Account(int accountNumber, String accountHolder, BigDecimal initialBalance) {
...
class AccountManager {
    ...
    public synchronized void createAccount(int accountNumber, String accountHolder, BigDecimal initialBalance) {
    ...
    public synchronized BigDecimal getBalance(int accountNumber) {
        Account account = accounts.get(accountNumber);
        if (account != null) {
